(function () {
    ...
    link.href = "https://shifraai-yjbu.onrender.com/assistant.css"
       ...
       <div class="shifra-top">
        ...
        <div class="shifra-bottom">
            ...
            <button class="shifra-mic">
               ...
               <img 
               src="https://shifraai-yjbu.onrender.com/mic.svg"
               alt="mic"
    ...
    button.innerHTML = `
    <img 
    src="https://shifraai-yjbu.onrender.com/logo.png"
    alt="logo"
    />`;
      ...
      recognition.onresult = (e)=>{
        ...
        setTimeout( async () => {
            try {
                ...
                const res = await fetch("https://five-shifraaiserver-a56x.onrender.com/api/assistant/ask" , {
                    method:"POST",
                    headers:{
                        "Content-Type":
                      "application/json",
